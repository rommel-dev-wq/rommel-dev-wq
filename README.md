...
**[ReportaBC](https://github.com/ReneBaez24/Proyecto-Manejo-de-residuos)** — Sistema web de reporte y gestión de residuos para Baja California, construido con PHP, MySQL y Leaflet.js para geolocalización. Incluye roles de usuario diferenciados (ciudadano, recolector, administrador) y flujo completo de asignación de reportes.

*Waste reporting and management web system for Baja California, built with PHP, MySQL, and Leaflet.js for geolocation. Includes differentiated user roles (citizen, collector, admin) and a full report-assignment workflow.*

---

<p align="center">
  <a href="https://linkedin.com/in/TU-USUARIO">LinkedIn</a> ·
  <a href="mailto:rommelhc3@gmail.com">Email</a>
</p>
